    ...
    <main className="min-h-screen bg-gradient-to-b from-froto-ice via-slate-50 to-white pb-16">
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-4 px-4 py-5 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">Listings, bids and Froto transaction history</p>
            </div>
          </div>
      ...
      <div className="mx-auto max-w-6xl space-y-6 px-4 pt-7">
        <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <Card className="rounded-[1.4rem] border-froto-teal/10 bg-white shadow-md shadow-froto-navy/5"><CardContent className="pt-6"><BarChart3 className="h-5 w-5 text-froto-teal" /><p className="mt-4 text-xs font-medium text-slate-500">Listings you are bidding on</p><p className="mt-1 text-2xl font-semibold text-froto-navy">{activeBidListings}</p></CardContent></Card>
          <Card className="rounded-[1.4rem] border-froto-green/10 bg-white shadow-md shadow-froto-navy/5"><CardContent className="pt-6"><Trophy className="h-5 w-5 text-froto-green" /><p className="mt-4 text-xs font-medium text-slate-500">Bids won</p><p className="mt-1 text-2xl font-semibold text-froto-navy">{wonBids}</p></CardContent></Card>
          <Card className="rounded-[1.4rem] border-froto-cyan/10 bg-white shadow-md shadow-froto-navy/5"><CardContent className="pt-6"><CircleDollarSign className="h-5 w-5 text-froto-cyan" /><p className="mt-4 text-xs font-medium text-slate-500">Completed job value</p><p className="mt-1 text-2xl font-semibold text-froto-navy">{formatAUD(completedValue)}</p></CardContent></Card>
        </section>
        ...
        <Card className="rounded-[1.75rem] border-froto-teal/10 bg-white shadow-md shadow-froto-navy/5">
          <CardHeader><div className="flex items-center justify-between gap-3"><div><p className="text-xs font-semibold uppercase tracking-[0.16em] text-froto-teal">Demand side</p><CardTitle className="mt-1 text-xl text-froto-navy">My Bids</CardTitle></div><BarChart3 className="h-5 w-5 text-froto-teal" /></div></CardHeader>
          <CardContent className="space-y-3">
